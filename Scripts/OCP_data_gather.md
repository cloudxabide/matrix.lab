...
echo "# VPC overview"
aws ec2 describe-vpcs --region us-east-1 --query 'Vpcs[*].[CidrBlock,Tags[?Key==`Name`].Value|[0]]' --output $OUTPUT

echo "# Subnet and their CIDR Blocks"
aws ec2 describe-subnets --region us-east-1 --query 'Subnets[*].[CidrBlock,SubnetId,Tags[?Key==`Name`].Value|[0]]' --output $OUTPUT
