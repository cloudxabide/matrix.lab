...
# Network information
network  --bootproto=static --device=eno1 --gateway=10.10.10.1 --ip=10.10.10.41 --nameserver=10.10.10.10,10.10.10.42,8.8.8.8 --netmask=255.255.255.0 --ipv6=auto --activate
network  --hostname=rama.matrix.lab
# Root password
...
part pv.01 --fstype="lvmpv" --ondisk=sda --size=242573
part /boot --fstype="xfs" --ondisk=sda --size=1024

# Volumes
volgroup rhel_rama --pesize=4096 pv.01
logvol /home --fstype="xfs" --grow --size=500 --name=home --vgname=rhel_rama
logvol swap --fstype="swap" --size=24419 --name=swap --vgname=rhel_rama
logvol / --fstype="xfs" --grow --size=1024 --name=root --vgname=rhel_rama
