...
# Network information
network --bootproto=static --device=eth0 --ip=10.10.10.110 --netmask=255.255.255.0 --gateway=10.10.10.1 --activate --nameserver=10.10.10.121,10.10.10.122 --hostname=rh7-lms-srv01.matrix.lab 
