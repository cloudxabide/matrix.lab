...
# Network information
network  --bootproto=static --device=eno1 --ip=10.10.10.13 --gateway=10.10.10.1 --nameserver=10.10.10.10,10.10.10.42,8.8.8.8 --netmask=255.255.255.0 --onboot=on --ipv6=auto 
network --bootproto=static --device=bond1 --ip=172.16.10.13 --netmask=255.255.255.0 --noipv6 --bondopts=miimon=100,mode=802.3ad,lacp_rate=1  --bondslaves=ens3f0,ens3f1
network --bootproto=static --device=bond2 --ip=169.254.0.13 --netmask=255.255.255.0 --bondopts=miimon=100,mode=802.3ad,lacp_rate=1  --bondslaves=ens3f2,ens3f3
