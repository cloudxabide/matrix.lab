...
# Network information
network  --bootproto=static --device=enp0s25 --gateway=10.10.10.1 --ip=10.10.10.10 --nameserver=10.10.10.10,10.10.10.42,8.8.8.8 --netmask=255.255.255.0 --onboot=off --ipv6=auto --no-activate
