...
# Network information
network  --bootproto=static --device=enp1s0 --gateway=10.10.10.1 --ip=10.10.10.117 --nameserver=10.10.10.10,10.10.10.42,8.8.8.8 --netmask=255.255.255.0 --ipv6=auto --activate
network  --hostname=rh8-test-srv04.matrix.lab
# Root password
