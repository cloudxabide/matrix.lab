...
# Network information
network  --bootproto=static --device=eno1 --onboot=on --ipv6=auto --activate --ip=10.10.10.12 --netmask=255.255.255.0 --gateway=10.10.10.1 --nameserver=10.10.10.10,10.10.10.42,8.8.8.8                     
...
network  --bootproto=static --device=ens3f2 --onboot=off --ipv6=auto --activate --ip=172.16.10.12 --netmask=255.255.255.0
network  --bootproto=static --device=ens3f3 --onboot=off --ipv6=auto --no-activate
network  --hostname=trinity.matrix.lab
...
# System timezone
timezone America/New_York --isUtc --ntpservers=2.rhel.pool.ntp.org,3.rhel.pool.ntp.org,1.rhel.pool.ntp.org
