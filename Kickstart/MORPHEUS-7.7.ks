...
# Network information
network  --bootproto=static --device=eno1 --onboot=on --ipv6=auto --activate --ip=10.10.10.13 --netmask=255.255.255.0 --gateway=10.10.10.1 --nameserver=10.10.10.10,10.10.10.42,8.8.8.8                     
